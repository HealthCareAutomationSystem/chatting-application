...
public class Server implements ActionListener{
    ...
    Server(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/doctor.png"));
       ...
       JLabel l3 = new JLabel("Dr. Rajeev");
    ...
    public static JPanel formatLabel(String out){
        ...
        l1.setBackground(new Color(171,255,185));
        l1.setOpaque(true);
